...
public class HiveORCFileRecordReader<K, V> extends RecordReader<NullWritable, ObjectWritable> {
    ...
    public void initialize(final InputSplit split, final TaskAttemptContext context) throws IOException, InterruptedException {
        final OrcInputFormat orcinputformat = new OrcInputFormat();
        ...
        this.reader = orcinputformat.getRecordReader((org.apache.hadoop.mapred.InputSplit) oldFileSplit, conf, Reporter.NULL);
    }
